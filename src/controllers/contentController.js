...
const getContent = asyncHandler(async function (req, res) {                        
    res.status(201).json(await getService(req.params.parentId));
})
const createContent = asyncHandler(async function (req, res) {                           
    res.status(201).json(await createService(req.body, req.body.parentId));
})
const patchContent = asyncHandler(async function (req, res) {                           
